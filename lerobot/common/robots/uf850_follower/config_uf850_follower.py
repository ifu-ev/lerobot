...
@RobotConfig.register_subclass("uf850_follower")
@dataclass
class Uf850Config(RobotConfig):
    """Configuration for uf850 robot."""
    ...
    def __post_init__(self):
        ...
        if len(self.joint_limits) != 6:
            raise ValueError("uf850 robot must have exactly 6 joint limits defined")
